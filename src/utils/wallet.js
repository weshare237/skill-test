...
// Duclair: Unexpected var, use let or const instead.
let minABI = [
  // balanceOf
  {
    constant: true,
...
export default class Wallet {
  ...
  encrypt(str) {
    ...
    const cipher = crypto.createCipheriv(algorithm, securityKey, initVector) // Duclair: Use a secure mode and padding scheme.
