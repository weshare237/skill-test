  ...
  return (
    ...
    <>
      <Row className='my-8 text-gray-400 text-md md:text-lg '>
        ...
        <Col xs={8} sm={8} md={6} className='text-center'>
          Last Price
        </Col>
        <Col xs={8} sm={8} md={6} className='text-center'>
          24h Change
        </Col>
        <Col span={6} className='text-right hidden md:block'>
          Markets
        </Col>
      </Row>
      {tableData.map((item, index) => (
        <Row className='text-sm md:text-xl my-4' key={index}>
          <Col xs={8} sm={8} md={6}>
            ...
            />
            {item.name}
            <span className='text-gray-400 hidden md:inline'>{`  ${item.network}`}</span>
          </Col>
          <Col
            xs={8}
            sm={8}
          ...
          <Col
            ...
            sm={8}
            md={6}
            className='text-center mytextGreen'
          >{`${item.change}%`}</Col>
