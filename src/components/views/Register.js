  ...
  return (
    ...
    >
      ...
      >
        ...
        <Form.Item className='mt-2'>
          <button
            onClick={login}
            type='submit'
            className='w-full bg-gray-800 text-md font-bold text-white  rounded-lg py-2'
          >
            {t('Log In')}
          </button>
        </Form.Item>
      ...
      <div className='text-center flex justify-between'>
        <Link to='/forgotpassword' className='myAnchor text-md ml-2'>
          {t('Forgot password?')}
        </Link>
        <Link to='/register' className='myAnchor text-md ml-2'>
          {t('Register now')}
        </Link>
      </div>
    </RegCard>
