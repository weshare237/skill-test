  ...
  return (
    <Row className='items-center mt-16'>
      <Col xs={{ span: 20, offset: 2 }} md={{ span: 0 }} className='mb-8'>
        <img src='/assets/img/phone_large.png' className='w-full' alt='' />
      </Col>
      <Col xs={{ span: 20, offset: 2 }} md={{ span: 9, offset: 3 }}>
        {advertismentData.map((item, idx) => (
          <Row className=' justify-center items-center my-2' key={idx}>
            <Col span={5}>
              <img src={item.picUrl} className='w-full' alt='' />
            </Col>
          ...
          <Col xs={{ span: 12 }} xl={{ span: 8, offset: 2 }} className=''>
            <a className='text-white hover:text-green-500 '>
              <div className='relative w-32 lg:w-40 m-auto'>
                <img src='/assets/img/googleplaybutton.png' alt='' />
                <span className='absolute bottom-1 right-2 text-lg'>
                  Google Play
                </span>
              </div>
            </a>
            {/* Duclair: The href attribute is required for an anchor to be keyboard accessible. Provide a valid, navigable address as the href value. If you cannot provide an href, but still need the element to resemble a link, use a button and change it with appropriate styles. */}
          </Col>
          <Col xs={{ span: 12 }} xl={{ span: 8 }} className=''>
            <a className='text-white hover:text-green-500 '>
              <div className='relative w-28 lg:w-36 m-auto'>
                <img src='/assets/img/appstorebutton.png' alt='' />
                <span className='absolute bottom-1 right-2 text-lg'>
                  App Store
                </span>
              </div>
