...
function Launch() {
  ...
  const getPresaleData = async () => {
    let bnbprice = await getTokenPriceInUsd(
      networks[2],
        ...
        <div className='w-5/6 lg:w-4/5 m-auto my-12 flex-grow'>
          <Row>
            ...
            <Col span={8} className='text-right'>
              {/* Duclair: The href attribute requires a valid value to be accessible. Provide a valid, navigable address as the href value. If you cannot provide a valid href, but still need the element to resemble a link, use a button and change it with appropriate styles. */}
              <a href='' className='font-bold'>
                <img
                  src='./assets/img/bsc.png'
                  className='inline mr-4 w-8'
                  alt=''
                />
                BSC MAINNET
              </a>
