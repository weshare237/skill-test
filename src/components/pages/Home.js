...
function Home() {
  ...
  const fetchData = async () => {
    // Duclair: Consider using 'await' for the promise inside this 'try' or replace it with 'Promise.prototype.catch(...)' usage.
    try {
      await axios.get(SERVER_URL + 'wallets/gettoptokens').then((response) => {
