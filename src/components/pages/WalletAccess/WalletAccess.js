...
function Launch(props) {
  ...
  async function accessWalletWithPrivateKey() {
    ...
    const response = await axios
      .post(serverUrl + 'wallets/access/privatekey', {
  ...
  async function accessWalletWithKeyphrase() {
    setAuthToken(localStorage.jwtToken)
    const response = await axios
      .post(serverUrl + 'wallets/access/keyphrase', {
      ...
      .catch((errorInfo) => {
        openNotification(t('Access failed.'), 'error', false)
      })
  }
                    ...
                    <Row>
                      ...
                      >
                        <Input
                          ...
                          value={privateKey}
                          onChange={(e) => {
                            onInputPrivateKey(e.target.value)
                          }}
                        />
                      </Col>
                    </Row>
                    <Row gutter={[16, 8]} className='wallet-button text-center'>
                      ...
                      >
                        <Button
                          ...
                          onClick={accessWalletWithPrivateKey}
                        >
                          {t('ACCESS WALLET')}
                        </Button>
                      </Col>
                    ...
                    <Row gutter={[6, 6]} className='walletSelect div-wrap'>
                      ...
                      <Col>
                        <Button
                          className='access-button'
                          style={{ marginTop: 10 }}
                          onClick={accessWalletWithKeyphrase}
                        >
                          {t('ACCESS WALLET')}
                        </Button>
                      </Col>
