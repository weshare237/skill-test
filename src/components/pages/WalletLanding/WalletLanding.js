...
function Launch() {
  ...
  const randomPhrase = () => {
    ...
    let min = 0
    let max = 11
    for (let i = 0; i < missPhrase_num; i++) {
  ...
  async function completeCreation() {
    ...
    const response = await axios
      ...
      .catch((errorInfo) => {
        openNotification(t('Access failed.'), t('error'), false)
      })
  }
  ...
  return (
    <>
            ...
            <div className='w-5/6 lg:w-4/5 m-auto my-12 flex-grow'>
              <Row>
                <Col
                  ...
                  md={{ offset: 5, span: 14 }}
                  lg={{ offset: 4, span: 16 }}
                  className='text-center header text-bold'
                >
                  {t(
                  ...
                  <Row className='walletSelect div-wrap'>
                    <Col className='div-relative'>
                      ...
                      <Row className='text-grey wallet-detail '>
                        <Col span={24}>{t('WELCOME BACK!')}</Col>
                      </Row>
                ...
                >
                  <Row className='walletSelect div-wrap'>
                    <Col className='div-relative'>
                      ...
                      <Row className='text-grey wallet-detail '>
                        <Col span={24}>{t('NEW TO MGL WALLET?')}</Col>
                      </Row>
                      <Row className='wallet-detail header'>
            ...
            <div className='w-5/6 lg:w-4/5 m-auto my-12 flex-grow'>
              <Row>
                ...
                <Col
                  ...
                  md={{ offset: 5, span: 14 }}
                  lg={{ offset: 8, span: 8 }}
                  className='text-center red-link'
                >
                      ...
                      <Link to='/walletphrase/0'>
                        <div className='access-mode'>
                          ...
                          <div>
                            ...
                            >
                              <path
                                d='M3.43823 9H4.93821V9.64285V11.5714V13.4999V14.4642V16.0713V17.357L4.18822 17.9999L3.43823 17.357V16.0713L4.18822 14.4642L3.43823 13.4999L4.18822 11.5714L3.43823 9.64285V9Z'
                                fill='#43294C'
                                stroke='#43294C'
                                strokeWidth='0.794702'
                              />
                              <path
                                d='M10.3468 7.55001L14.7181 14.6549L14.4308 15.6L13.4529 15.4607L12.7623 14.3763L12.5315 12.6178L11.3809 12.2074L10.9775 10.1779L8.96235 8.54969L10.3468 7.55001Z'
                                fill='#43294C'
                                stroke='#43294C'
                                strokeWidth='0.794702'
                              />
                              ...
                              <circle
                                ...
                                cy='5.17772'
                                r='3.35259'
                                transform='rotate(-32.4933 7.86365 5.17772)'
                                stroke='#43294C'
                                strokeWidth='0.794702'
                              />
                            </svg>
                      ...
                      <Link to='/walletphrase/1'>
                        <div className='access-mode'>
                          ...
                          <div>
                            ...
                            >
                              <path
                                d='M1.5 0.397351C2.10898 0.397351 2.60265 0.891024 2.60265 1.5C2.60265 2.10898 2.10898 2.60265 1.5 2.60265C0.891024 2.60265 0.397351 2.10898 0.397351 1.5C0.397351 0.891024 0.891024 0.397351 1.5 0.397351Z'
                                fill='#43294C'
                                stroke='#43294C'
                                strokeWidth='0.794702'
                              />
                              <path
                                d='M1.5 5.39735C2.10898 5.39735 2.60265 5.89102 2.60265 6.5C2.60265 7.10898 2.10898 7.60265 1.5 7.60265C0.891024 7.60265 0.397351 7.10898 0.397351 6.5C0.397351 5.89102 0.891024 5.39735 1.5 5.39735Z'
                                fill='#43294C'
                                stroke='#43294C'
                                strokeWidth='0.794702'
                              />
                              <path
                                d='M1.5 10.3974C2.10898 10.3974 2.60265 10.891 2.60265 11.5C2.60265 12.109 2.10898 12.6026 1.5 12.6026C0.891024 12.6026 0.397351 12.109 0.397351 11.5C0.397351 10.891 0.891024 10.3974 1.5 10.3974Z'
                                fill='#43294C'
                                stroke='#43294C'
                                strokeWidth='0.794702'
                              />
                ...
                <Col
                  ...
                  className='text-center red-link'
                >
                  <button onClick={cancelWallet}>{t('Cancel')}</button>
                </Col>
              </Row>
            </div>
          ) : !phraseMode && createMode ? (
            <div className='w-5/6 lg:w-4/5 m-auto my-12 flex-grow'>
              <Row>
                <Col
                  xs={{ offset: 1, span: 22 }}
                ...
                >
                  <Row>
                    ...
                    <Col span={24} className='text-center red-link'>
                      <button onClick={accessWallet}>
                        {t('Already have a wallet?')}
                      </button>
                    </Col>
                    <Col span={24} className='text-center'>
                      <Button
                        className='genkey-button'
                        onClick={generatePhrase}
                      >
                        {t('GENERATE KEY PHRASE')}
                      </Button>
                    </Col>
                    <Col span={24} className='text-center red-link'>
                      <button onClick={cancelWallet}>{t('Cancel')}</button>
                ...
                >
                  <Row className='div-wrap'>
                    <Col span={24}>
                      ...
                      <Row
                        className='text-grey wallet-detail'
                        style={{ fontSize: 18 }}
                      >
                        <div className='walletSelect'>{mnemonic}</div>
                      </Row>
                      <Row className='wallet-detail wallet-button'>
                        <Col span={24}>
                          <Button
      ...
      {modalShow ? (
        <WalletVerifyModal
          setTypedMnemonic={setTypedMnemonic}
          typedMnemonic={typedMnemonic}
          mnemonic={mnemonic}
          setVerify={setVerify}
          setModalShow={setModalShow}
          missPhrase={missPhrase}
        />
      ) : null}
    </>
  )
